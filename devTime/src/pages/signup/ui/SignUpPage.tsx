      ...
      <div className='flex-1 flex flex-col justify-center items-center'>
        ...
        <div className='flex flex-col mb-10'>
          ...
          <div className='flex gap-3'>
            <input
              ...
              className='w-[324px] h-11 px-4 py-3 rounded-[5px] bg-gray-50 text-body-m text-gray-400'
            />
        ...
        <div className='flex flex-col mb-10'>
          ...
          <input
            ...
            className='w-[423px] h-11 px-4 py-3 rounded-[5px] bg-gray-50 text-body-m text-gray-400'
          />
        </div>
        ...
        <button className='w-[423px] h-12 bg-gray-400 rounded-[5px] text-gray-300 text-subtitle-s mb-6'>
          회원가입
        </button>
